...
const SidebarList = () => {
  const links: LinkList[] = [
    ...
    {
      href: '/counter-management',
      label: 'Counter Management',
      icon: <ClockIcon width={24} />
    },
    { href: '/user-queue-management', label: 'User Queue Management', icon: <ClockIcon width={24} /> },
    { href: '/shop-queue-management', label: 'Shop Queue Management', icon: <QueueListIcon width={24} /> },
    { href: '/business-management', label: 'Business Management', icon: <ClockIcon width={24} /> },
  ]
  return (
